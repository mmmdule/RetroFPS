...
public class BossImp : MonoBehaviour
{
    ...
    public float health = 40 * 70; //(40 shotgun blasts)
...
//      player = GameObject.FindGameObjectWithTag("Player").transform;
    ...
    private void AttackPlayer()
    {
        ...
        if (!alreadyAttacked && !disableAttack)
        {
            ...
            //The line above creates a glitch that causes the Enemy to fire a continuous stream
            //of projectiles at the Player (like a chaingun/energy beam of projectiles)
            //keep it here to achieve that effect, but make the Boss immobile (fixed position)
            //kinda like the first boss of GunGodz.
            //Add cover areas like the GunGodz boss too, and ocassionaly spawn the odd Imp/Tri-Imp
            //Add a few of the rotating spheres traps into the arena as well
